...
- [三、Java语言的特点](#--java-----)
  ...
  * [7. 多线程](#7----)
  * [8. 健壮性](#8----)
- [四、JVM、JRE和JDK](#--jvm-jre-jdk)
  * [JVM(Java Virtual Machine Java虚拟机):](#jvm-java-virtual-machine-java-----)
  * [JRE(Java Runtime Environment Java运行环境)：](#jre-java-runtime-environment-java------)
  * [JDK(Java Development Kit Java开发工具包)：](#jdk-java-development-kit-java-------)
- [五、数据类型](#------)
  * [1. 整数类型](#1-----)
  * [2. 浮点数类型](#2------)
  * [3. 布尔类型](#3-----)
